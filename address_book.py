...
if __name__ == "__main__":
    ...
    contact1 = Contact(first_name="Aniket", last_name="wagh", address="203 swaraj nagri", city="Talegaon Dabhade", state="MH", zip_code="422620", phone_number="91 9322365844", email="contact@aniketwagh.com")
